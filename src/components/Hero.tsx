    ...
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-30 text-center px-6 max-w-5xl py-20 md:py-0">
        ...
        >
          ...
          <h1 className="font-serif text-[48px] md:text-[72px] leading-tight mb-8 md:mb-10 tracking-tight text-white/90 max-w-3xl mx-auto" style={{ fontFamily: '"Cormorant Garamond", serif', fontWeight: 200 }}>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <button 
              ...
              className="bg-white text-black px-10 py-4 rounded-sm text-[12px] tracking-[0.3em] font-bold hover:bg-gold hover:text-white transition-all duration-500 w-auto"
            >
              BROWSE FLEET
            </button>
            <button 
              onClick={onContact}
              className="bg-transparent text-white px-10 py-4 rounded-sm text-[12px] tracking-[0.3em] font-medium hover:text-gold hover:bg-white/10 transition-all duration-500 w-auto uppercase"
            >
              CONTACT US
            </button>
          </div>
